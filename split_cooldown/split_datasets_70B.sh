...
srun --environment="${SCRIPT_DIR}/../nemo.toml" bash -c "\
    ...
    python -u '${SLURM_SUBMIT_DIR}/split_datasets.py' \
        --input-dir /iopsstor/scratch/cscs/ahuang/apertus_dataset/prepare-70b/text_stage_3 \
                    /capstor/store/cscs/swissai/infra01/vision-datasets/Apertus1p5_cooldown_tokenized/70B \
