...
DATASETS = {
    "Biomed-Enriched_preprocessed":
        "/capstor/store/cscs/swissai/infra01/datasets_tokenized/Biomed-Enriched-preprocessed",
    "dolma3_olmocr_science_pdfs-preprocessed":
        "/capstor/store/cscs/swissai/infra01/datasets_tokenized/dolma3_olmocr_science_pdfs-preprocessed",
    "institutional-books-1.0-filtered":
        "/capstor/store/cscs/swissai/infra01/datasets_tokenized/institutional-books-1.0-filtered",
    "finepdfs-edu-multilingual-preprocessed":
        "/capstor/store/cscs/swissai/infra01/datasets_tokenized/finepdfs-edu-multilingual-preprocessed/Apertus-70B-2509/finepdfs-edu-multilingual-preprocessed_second_half_longcontext",
    "finepdfs-edu-preprocessed":
        "/capstor/store/cscs/swissai/infra01/datasets_tokenized/finepdfs-edu-preprocessed/Apertus-70B-2509/finepdfs-edu-preprocessed-second_half_longcontext",
    "finetranslations":
        "/capstor/store/cscs/swissai/infra01/datasets_tokenized/finetranslations_preprocessed/Apertus-70B-2509/finetranslations-second_half_longcontext",
    "swissai-fineweb-2_0_1-quality_10-filterrobots":
        "/capstor/store/cscs/swissai/infra01/datasets_tokenized/fineweb-2_0_1-quality_10-100_langs-filterrobots/Apertus-70B-2509/swissai-fineweb-2_0_1-quality_10-filterrobots-second_half_longcontext",
    "Audio":
        "/capstor/store/cscs/swissai/infra01/audio-datasets/Apertus1p5_lct_tokenized",
    "Image":
        "/capstor/store/cscs/swissai/infra01/vision-datasets/Apertus1p5_lct_tokenized/8B",
    "Image-extra":
        "/capstor/store/cscs/swissai/infra01/vision-datasets/Apertus1p5_lct_tokenized/70B",
}
...
SAMPLING_CONFIG = {
    ...
    "mix_16k_32k": {
        ...
        "sources": {
            ...
            "Audio":                                         1_330_000_000,
            "Image-extra": [
                {"target": 14_000_000, "bucket": "lt_16k"},
            ],
    ...
    "mix_64k_128k": {
        ...
        "sources": {
            ...
            "Image": [
                {"target": 1_790_000_000, "bucket": "64k_128k"},
                {"target": 3_540_000_000, "bucket": "lt_16k"},
            ],
        },
    },
